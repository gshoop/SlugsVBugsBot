...
#define EVENT_CHECK_LIST  CheckBattery, CheckBeacon, CheckTrackWire, CheckAimTapeSensor,
...
#define TIMER1_RESP_FUNC PostTapeSensorService  //TapeSensor_Service_Timer
#define TIMER2_RESP_FUNC PostTopLevelHSM        //Reverse_Turn_Timer
#define TIMER3_RESP_FUNC PostTopLevelHSM        //Vat_Corner_Turn_Timer
#define TIMER4_RESP_FUNC PostTopLevelHSM        //Tank_Turn_Timer
#define TIMER5_RESP_FUNC PostTopLevelHSM        //Aiming_Timer
#define TIMER6_RESP_FUNC PostTopLevelHSM        //Scan_Timer
#define TIMER7_RESP_FUNC PostTopLevelHSM        //Scanning_Timer
#define TIMER8_RESP_FUNC PostTopLevelHSM        //Line_Repel_Timer
#define TIMER9_RESP_FUNC PostTopLevelHSM 
#define TIMER10_RESP_FUNC PostTopLevelHSM
...
#define BUMPER_SERVICE_TIMER 0 /*make sure this is enabled above and posting to the correct state machine*/
#define TAPESENSOR_SERVICE_TIMER 1
#define REVERSE_TURN_TIMER 2
#define VAT_CORNER_TURN_TIMER 3
#define TANK_TURN_TIMER 4
#define AIMING_TIMER 5
#define SCAN_TIMER 6
#define SCANNING_TIMER 7
#define LINE_REPEL_TIMER 8
#define SHOOT_TIMER 9
#define RUN_AWAY_TIMER 10
